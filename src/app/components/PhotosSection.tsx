  ...
  return (
    <div className='flex flex-col gap-40 px-20 pb-40'>
      ...
      <div className='z-10 inline-flex justify-between'>
        <div className='relative border-8 border-white/10 border-opacity-20 backdrop-blur-lg overflow-hidden group w-fit max-2xl:w-[50%] shadow shadow-white/20'>
      ...
      <div className='z-10 inline-flex justify-between'>
        ...
        <div className='relative border-8 border-white/10 border-opacity-20 backdrop-blur-lg overflow-hidden group self-end  max-2xl:w-[60%] shadow shadow-white/20'>
      ...
      <div className='z-10 inline-flex justify-around'>
        <div className='z-10 relative w-fit border-8 border-white/10 border-opacity-20 backdrop-blur-lg overflow-hidden group shadow shadow-white/20'>
      ...
      <div className='z-10 inline-flex justify-between'>
        ...
        <div className='z-10 relative border-8 border-white/10 border-opacity-20 backdrop-blur-lg overflow-hidden group self-end max-2xl:w-[60%] shadow shadow-white/20'>
      ...
      <div className='z-10 inline-flex justify-between'>
        <div className='z-10 relative border-8 border-white/10 border-opacity-20 backdrop-blur-lg overflow-hidden group w-fit max-2xl:w-[50%] shadow shadow-white/20'>
